...
public class ToastUtils {
    ...
    public static void showToast(int resID) {
        showToast(InitApp.AppContext, Toast.LENGTH_SHORT, resID);
    }

    public static void showToast(String text) {
        showToast(InitApp.AppContext, Toast.LENGTH_SHORT, text);
    }
    ...
    public static void showLongToast(int resID) {
        showToast(InitApp.AppContext, Toast.LENGTH_LONG, resID);
    }
    ...
    public static void showLongToast(String text) {
        showToast(InitApp.AppContext, Toast.LENGTH_LONG, text);
    }
